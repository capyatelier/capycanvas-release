...
export function createRasterWorker() {
  ...
  function owner(kind) {
    ...
    const worker = new Worker(new URL("./raster-worker.8616147fcc2c420a6bc6.js", import.meta.url), {type:"module"});
    ...
    const state = {worker,pending,fail,active(){clearTimeout(idleTimer);}}; owners.set(kind,state); return state;
  }
