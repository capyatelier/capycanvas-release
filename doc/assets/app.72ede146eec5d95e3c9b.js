import init, { WebApp, WebGpu, configure_raster_worker, automatic_tab_names } from "./pkg/layer_web.84c9d03dc570dba9efb4.js";
import { createRasterWorker } from "./raster-worker-client.c8a8c2dd9f4618eee349.js";
import { createDocumentStorage } from "./document-storage.0cd79375ad1454702a49.js";
import { workspaceStore, modulePromise, setWorkspaceWake } from "./workspace-preload.818312614c4610043b54.js";
import { createWorkspaceManager } from "./workspace-manager.d15cd2281e8e027a7196.js";
import { createPreferences } from "./preferences.9226b8cb428dfc627160.js";
import { showGpuNotice } from "./gpu.974d8febbbb3582fae28.js";
import { createCustomization } from "./customization.19230af292eceaa9c035.js";
import { createEditorPanels } from "./editor-panels.4bef5fd8eafc3bf14f19.js";
import { createWorkspaceChrome } from "./workspace-chrome.66fdb44deff83d680274.js";
import { createGlass } from "./glass.aef6884500fc33410608.js";
import { createDocuments } from "./documents.859b0a285283d517c009.js";
import { createSystemStatus } from "./system-status.0b65cd2ebafa25dc9cf0.js";
import { createHeader } from "./header.fc9a683714e57c7eed02.js";
...
import { createLayerPanel } from "./layers.3a2be7fa271cd72ae7d7.js";
import { createPalettes } from "./palettes.a52d6af3c8b2ca1a50b7.js";
import { createEffectPanels, fetchFilterPackage } from "./effects.4f04abbe43940f14485b.js";
