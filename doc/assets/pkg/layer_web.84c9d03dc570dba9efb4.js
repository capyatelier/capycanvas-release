...
export class WebApp {
     ...
     * @returns {string}
     */
    action_tooltip(label, action) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(label, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.webapp_action_tooltip(this.__wbg_ptr, ptr0, len0, action);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     */
    adjacent_document(forward) {
        const ret = wasm.webapp_adjacent_document(this.__wbg_ptr, forward);
     ...
     * @returns {any}
     */
    adopt_document(project, location) {
    ...
    application_link(link) {
        ...
        let deferred2_1;
        try {
            const ret = wasm.webapp_application_link(this.__wbg_ptr, link);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     */
    attach_gpu(gpu) {
        _assertClass(gpu, WebGpu);
        var ptr0 = gpu.__destroy_into_raw();
        const ret = wasm.webapp_attach_gpu(this.__wbg_ptr, ptr0);
        if (ret[1]) {
     ...
     */
    backdrop_frames() {
        const ret = wasm.webapp_backdrop_frames(this.__wbg_ptr);
     ...
     * @returns {boolean}
     */
    begin_header_drag(query) {
        const ret = wasm.webapp_begin_header_drag(this.__wbg_ptr, query);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] !== 0;
     ...
     * @param {any} clip
     */
    begin_tab_drag(tabs, clip) {
        const ret = wasm.webapp_begin_tab_drag(this.__wbg_ptr, tabs, clip);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    camera() {
        const ret = wasm.webapp_camera(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    /**
     * @param {bigint} id
     * @returns {WebRecoveryCapture}
     */
    capture_tab_recovery(id) {
        const ret = wasm.webapp_capture_tab_recovery(this.__wbg_ptr, id);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WebRecoveryCapture.__wrap(ret[0]);
    }
    /**
     * @returns {any}
     */
     ...
     */
    close_document_tab() {
        const ret = wasm.webapp_close_document_tab(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {Uint8Array}
     */
    color_field_pixels(side) {
        const ret = wasm.webapp_color_field_pixels(this.__wbg_ptr, side);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
     ...
     * @returns {string}
     */
    color_field_request(side) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.webapp_color_field_request(this.__wbg_ptr, side);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     */
    color_hue_stops() {
        const ret = wasm.webapp_color_hue_stops(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    color_panel() {
        const ret = wasm.webapp_color_panel(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    color_preview() {
        const ret = wasm.webapp_color_preview(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    color_wheel_hit(size, x, y) {
        const ret = wasm.webapp_color_wheel_hit(this.__wbg_ptr, size, x, y);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @param {boolean} allow_optional
     * @returns {Promise<any>}
     */
    compile_startup_step(allow_optional) {
        const ret = wasm.webapp_compile_startup_step(this.__wbg_ptr, allow_optional);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    static create(canvas) {
        const ret = wasm.webapp_create(canvas);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WebApp.__wrap(ret[0]);
    }
    /**
    ...
    cursor_input(sample) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.webapp_cursor_input(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {any} action
     * @returns {any}
     */
    dispatch(action) {
        const ret = wasm.webapp_dispatch(this.__wbg_ptr, action);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {boolean}
     */
    document_close_available() {
        const ret = wasm.webapp_document_close_available(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {any}
     ...
     * @returns {any}
     */
    document_drop(hits, x, y, vertical) {
        const ret = wasm.webapp_document_drop(this.__wbg_ptr, hits, x, y, vertical);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    document_order_history(redo) {
        const ret = wasm.webapp_document_order_history(this.__wbg_ptr, redo);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    document_park_ready() {
        const ret = wasm.webapp_document_park_ready(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] !== 0;
     ...
     * @returns {any}
     */
    document_slide(request) {
        const ret = wasm.webapp_document_slide(this.__wbg_ptr, request);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    document_tabs(width) {
        const ret = wasm.webapp_document_tabs(this.__wbg_ptr, width);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    dragging_attached_tab() {
        const ret = wasm.webapp_dragging_attached_tab(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @param {any} query
     ...
     */
    drawer(query) {
        const ret = wasm.webapp_drawer(this.__wbg_ptr, query);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    drawer_toolbar(panel, width) {
        const ret = wasm.webapp_drawer_toolbar(this.__wbg_ptr, panel, width);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    editor_models(_width, _height) {
        const ret = wasm.webapp_editor_models(this.__wbg_ptr, _width, _height);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    filter_package_modules(manifest) {
        const ptr0 = passStringToWasm0(manifest, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webapp_filter_package_modules(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    finish_document(id, success, error) {
        var ptr0 = isLikeNone(error) ? 0 : passStringToWasm0(error, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        const ret = wasm.webapp_finish_document(this.__wbg_ptr, id, success, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    finish_header_drag(x, y, cancel) {
        const ret = wasm.webapp_finish_header_drag(this.__wbg_ptr, x, y, cancel);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    /**
     * @param {number} now_ms
     * @param {number} presentation_ms
     * @returns {any}
     */
    frame(now_ms, presentation_ms) {
        const ret = wasm.webapp_frame(this.__wbg_ptr, now_ms, presentation_ms);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    gesture(from_x, from_y, to_x, to_y, scale, rotation) {
        const ret = wasm.webapp_gesture(this.__wbg_ptr, from_x, from_y, to_x, to_y, scale, rotation);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    gpu_failure() {
        const ret = wasm.webapp_gpu_failure(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
     ...
     */
    gpu_ready() {
        const ret = wasm.webapp_gpu_ready(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @param {number} group
    ...
    group_tab_style(group) {
        const ret = wasm.webapp_group_tab_style(this.__wbg_ptr, group);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    header_drag_preview(x, y) {
        const ret = wasm.webapp_header_drag_preview(this.__wbg_ptr, x, y);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    header_geometry(width, insets, metrics) {
        const ret = wasm.webapp_header_geometry(this.__wbg_ptr, width, insets, metrics);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    header_step(id, forward) {
        const ret = wasm.webapp_header_step(this.__wbg_ptr, id, forward);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    header_view() {
        const ret = wasm.webapp_header_view(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    input(input) {
        const ret = wasm.webapp_input(this.__wbg_ptr, input);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    layer_menu(id, mask) {
        const ret = wasm.webapp_layer_menu(this.__wbg_ptr, id, mask);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    layout(width, height) {
        const ret = wasm.webapp_layout(this.__wbg_ptr, width, height);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    load_filter_library(manifest, modules, mode) {
        const ptr0 = passStringToWasm0(manifest, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webapp_load_filter_library(this.__wbg_ptr, ptr0, len0, modules, mode);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    load_filter_package(manifest, modules, mode) {
        const ptr0 = passStringToWasm0(manifest, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webapp_load_filter_package(this.__wbg_ptr, ptr0, len0, modules, mode);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    navigator_aspect() {
        const ret = wasm.webapp_navigator_aspect(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} width
     ...
     * @returns {any}
     */
    navigator_geometry(width, height) {
        const ret = wasm.webapp_navigator_geometry(this.__wbg_ptr, width, height);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @param {HTMLCanvasElement} canvas
     */
    navigator_surface(id, canvas) {
        wasm.webapp_navigator_surface(this.__wbg_ptr, id, canvas);
    }
    /**
     * @param {any} request
     * @returns {any}
     */
    number_input(request) {
        const ret = wasm.webapp_number_input(this.__wbg_ptr, request);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {string | undefined}
     */
    palette_action_error(action) {
        const ret = wasm.webapp_palette_action_error(this.__wbg_ptr, action);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        let v1;
     ...
     */
    palette_menu(target) {
        const ret = wasm.webapp_palette_menu(this.__wbg_ptr, target);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    palette_panel() {
        const ret = wasm.webapp_palette_panel(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    /**
     * @param {bigint} palette
     * @param {bigint} id
     * @param {number} slot
     * @returns {any}
     */
    palette_reorder_preview(palette, id, slot) {
        const ret = wasm.webapp_palette_reorder_preview(this.__wbg_ptr, palette, id, slot);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    panel_handle_target(item) {
        const ret = wasm.webapp_panel_handle_target(this.__wbg_ptr, item);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @param {Float64Array} records
     * @param {bigint} view_revision
     * @returns {number}
     */
    pen(records, view_revision) {
        const ptr0 = passArrayF64ToWasm0(records, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webapp_pen(this.__wbg_ptr, ptr0, len0, view_revision);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
     ...
     * @returns {any}
     */
    poll_filter_previews(filters, cache, width, height, now_ms) {
        const ret = wasm.webapp_poll_filter_previews(this.__wbg_ptr, filters, cache, width, height, now_ms);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    prediction_availability(available) {
        wasm.webapp_prediction_availability(this.__wbg_ptr, available);
    }
    /**
     * @returns {any}
     */
    preferences() {
        const ret = wasm.webapp_preferences(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    preferences_cached() {
        const ret = wasm.webapp_preferences_cached(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @param {Function | null} [cancelled]
     * @returns {Promise<any>}
     */
    prepare_document(id, bytes, width, height, epoch, revision, recovered, source_name, options, interpret, cancelled) {
        var ptr0 = isLikeNone(source_name) ? 0 : passStringToWasm0(source_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        const ret = wasm.webapp_prepare_document(this.__wbg_ptr, id, isLikeNone(bytes) ? 0 : addToExternrefTable0(bytes), width, height, epoch, revision, isLikeNone(recovered) ? 0xFFFFFF : recovered ? 1 : 0, ptr0, len0, options, isLikeNone(interpret) ? 0 : addToExternrefTable0(interpret), isLikeNone(cancelled) ? 0 : addToExternrefTable0(cancelled));
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    proof_control(action) {
        const ret = wasm.webapp_proof_control(this.__wbg_ptr, action);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    proof_texture(edge) {
        const ret = wasm.webapp_proof_texture(this.__wbg_ptr, edge);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
     ...
     * @returns {any}
     */
    recovery_document_for(id) {
        const ret = wasm.webapp_recovery_document_for(this.__wbg_ptr, id);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @param {number} id
     */
    remove_navigator_surface(id) {
        wasm.webapp_remove_navigator_surface(this.__wbg_ptr, id);
    }
    /**
     * @returns {any}
     */
    renderer_stats() {
        const ret = wasm.webapp_renderer_stats(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    /**
     * @param {bigint} id
     * @param {bigint | null} [before]
     * @returns {any}
     */
    reorder_document(id, before) {
        const ret = wasm.webapp_reorder_document(this.__wbg_ptr, id, !isLikeNone(before), isLikeNone(before) ? BigInt(0) : before);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {boolean}
     */
    request_layer_thumbnail(request, target) {
        const ret = wasm.webapp_request_layer_thumbnail(this.__wbg_ptr, request, target);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] !== 0;
    ...
    reset_document_close() {
        wasm.webapp_reset_document_close(this.__wbg_ptr);
    }
    /**
     * @param {number} id
     * @param {any} decision
     ...
     */
    resume_document_gpu() {
        const ret = wasm.webapp_resume_document_gpu(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] !== 0;
     ...
     * @returns {Promise<any>}
     */
    save_project(id, location) {
        const ret = wasm.webapp_save_project(this.__wbg_ptr, id, location);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    save_recovery(key) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webapp_save_recovery(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    scroll(x, y, dx, dy, dpi, modifiers) {
        const ret = wasm.webapp_scroll(this.__wbg_ptr, x, y, dx, dy, dpi, modifiers);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    select_document(id) {
        const ret = wasm.webapp_select_document(this.__wbg_ptr, id);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    selection_menu(kind) {
        const ret = wasm.webapp_selection_menu(this.__wbg_ptr, kind);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {boolean}
     */
    set_display_hdr(available) {
        const ret = wasm.webapp_set_display_hdr(this.__wbg_ptr, available);
        return ret !== 0;
    }
    /**
     ...
     * @param {number} bytes
     */
    set_document_cache_budget(bytes) {
        wasm.webapp_set_document_cache_budget(this.__wbg_ptr, bytes);
    }
    /**
     * @param {Float32Array} boxes
     * @param {any} connections
     * @param {boolean} squircle
     */
    set_glass(boxes, connections, squircle) {
        const ptr0 = passArrayF32ToWasm0(boxes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webapp_set_glass(this.__wbg_ptr, ptr0, len0, connections, squircle);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @returns {boolean}
     */
    shader_work_pending(allow_optional) {
        const ret = wasm.webapp_shader_work_pending(this.__wbg_ptr, allow_optional);
        return ret !== 0;
    }
    /**
     * @returns {Promise<any>}
     */
    spill_document_tiles() {
        const ret = wasm.webapp_spill_document_tiles(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    start_stroke_recording() {
        const ret = wasm.webapp_start_stroke_recording(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    state_update() {
        const ret = wasm.webapp_state_update(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    step_document(id, forward) {
        const ret = wasm.webapp_step_document(this.__wbg_ptr, id, forward);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    stop_stroke_recording() {
        wasm.webapp_stop_stroke_recording(this.__wbg_ptr);
    }
    /**
     * @returns {Uint8Array}
     */
    stroke_recording_bytes() {
        const ret = wasm.webapp_stroke_recording_bytes(this.__wbg_ptr);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
     ...
     * @returns {Uint8Array}
     */
    stroke_recording_data() {
        const ret = wasm.webapp_stroke_recording_data(this.__wbg_ptr);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    ...
    stroke_recording_saved() {
        wasm.webapp_stroke_recording_saved(this.__wbg_ptr);
    }
    /**
     * @returns {any}
     */
    stroke_recording_status() {
        const ret = wasm.webapp_stroke_recording_status(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    suspend_gpu() {
        const ret = wasm.webapp_suspend_gpu(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    tab_drag_preview(position) {
        const ret = wasm.webapp_tab_drag_preview(this.__wbg_ptr, position);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    take_layer_thumbnail() {
        const ret = wasm.webapp_take_layer_thumbnail(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    tone_apply(tone) {
        _assertClass(tone, WebTone);
        var ptr0 = tone.__destroy_into_raw();
        const ret = wasm.webapp_tone_apply(this.__wbg_ptr, ptr0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] !== 0;
     ...
     * @param {string} error
     */
    tone_failed(generation, error) {
        const ptr0 = passStringToWasm0(error, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.webapp_tone_failed(this.__wbg_ptr, generation, ptr0, len0);
    }
    /**
     * @param {WebCaptureControl} control
     * @returns {Promise<any>}
     */
    tone_prepare(control) {
        _assertClass(control, WebCaptureControl);
        const ret = wasm.webapp_tone_prepare(this.__wbg_ptr, control.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    tone_status() {
        const ret = wasm.webapp_tone_status(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    toolbar_manager() {
        const ret = wasm.webapp_toolbar_manager(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    toolbar_prompt() {
        const ret = wasm.webapp_toolbar_prompt(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    toolbar_stamp(context) {
        const ret = wasm.webapp_toolbar_stamp(this.__wbg_ptr, context);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    toolbar_ui(request) {
        const ret = wasm.webapp_toolbar_ui(this.__wbg_ptr, request);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    workspace_menu() {
        const ret = wasm.webapp_workspace_menu(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    workspace_persistence() {
        const ret = wasm.webapp_workspace_persistence(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    workspace_projection(_width, _height) {
        const ret = wasm.webapp_workspace_projection(this.__wbg_ptr, _width, _height);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    workspace_update() {
        const ret = wasm.webapp_workspace_update(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
export class WebGpu {
    static __wrap(ptr) {
        const obj = Object.create(WebGpu.prototype);
        obj.__wbg_ptr = ptr;
        WebGpuFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WebGpuFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_webgpu_free(ptr, 0);
    }
    /**
     * @param {HTMLCanvasElement} canvas
     * @param {any} color
...
export class WebProject {
    static __wrap(ptr) {
        const obj = Object.create(WebProject.prototype);
        obj.__wbg_ptr = ptr;
        WebProjectFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WebProjectFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_webproject_free(ptr, 0);
    }
}
...
export class WebRecoveryCapture {
    static __wrap(ptr) {
        const obj = Object.create(WebRecoveryCapture.prototype);
        obj.__wbg_ptr = ptr;
        WebRecoveryCaptureFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WebRecoveryCaptureFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_webrecoverycapture_free(ptr, 0);
    }
    /**
     * @param {string} key
     * @returns {Promise<any>}
    ...
    write(key) {
        const ptr0 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webrecoverycapture_write(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
if (Symbol.dispose) WebRecoveryCapture.prototype[Symbol.dispose] = WebRecoveryCapture.prototype.free;
...
export class WebTone {
    static __wrap(ptr) {
        const obj = Object.create(WebTone.prototype);
        obj.__wbg_ptr = ptr;
        WebToneFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WebToneFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_webtone_free(ptr, 0);
    }
}
if (Symbol.dispose) WebTone.prototype[Symbol.dispose] = WebTone.prototype.free;
 ...
 * @returns {Uint8Array}
 */
export function automatic_tab_names(available, widths) {
    const ptr0 = passArrayF32ToWasm0(widths, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.automatic_tab_names(available, ptr0, len0);
 ...
 * @returns {Uint8Array}
 */
export function proof_texture_build(edge) {
    const ret = wasm.proof_texture_build(edge);
    var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v1;
}
 ...
 * @returns {Uint8Array}
 */
export function raster_worker_color_field(metadata) {
    const ptr0 = passStringToWasm0(metadata, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.raster_worker_color_field(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
export function raster_worker_encode(metadata, bytes) {
    const ptr0 = passStringToWasm0(metadata, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.raster_worker_encode(ptr0, len0, ptr1, len1);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @returns {Array<any>}
 */
export function raster_worker_palette_file(request, bytes) {
    const ptr0 = passStringToWasm0(request, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.raster_worker_palette_file(ptr0, len0, bytes);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 */
export function raster_worker_write(metadata, buffers) {
    const ptr0 = passStringToWasm0(metadata, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.raster_worker_write(ptr0, len0, buffers);
    return ret;
}
 ...
 * @param {number} now
 * @param {string[] | null | undefined} live_owners
 * @param {number} owners_at
 * @returns {any}
 */
export function workspace_database(snapshot, request, pending, now, live_owners, owners_at) {
    const ptr0 = passStringToWasm0(request, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(live_owners) ? 0 : passArrayJsValueToWasm0(live_owners, wasm.__wbindgen_malloc);
    var len1 = WASM_VECTOR_LEN;
    const ret = wasm.workspace_database(snapshot, ptr0, len0, pending, now, ptr1, len1, owners_at);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_createComputePipelineAsync_51f59036dc7fb5e2: function(arg0, arg1) {
        ...
        __wbg_createRenderPipelineAsync_5d1472d1f672d6b6: function(arg0, arg1) {
        ...
        __wbg_new_8f72ed7c652bf5a2: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen__convert__closures_____invoke__h55ec132eb4f3ab70(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbg_webtone_new: function(arg0) {
            const ret = WebTone.__wrap(arg0);
            return ret;
        },
        ...
        __wbindgen_generic_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 3540, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hb9650d4d790454a3);
            return ret;
        },
        __wbindgen_generic_0000000000000002: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("GPUComputePipeline")], shim_idx: 2261, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h097b13ea2da0a79b);
            return ret;
        },
        __wbindgen_generic_0000000000000003: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("GPUDevice")], shim_idx: 2261, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h097b13ea2da0a79b_198);
            return ret;
        },
        __wbindgen_generic_0000000000000004: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("GPUDeviceLostInfo")], shim_idx: 2259, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hb1d9772773f8ef96);
            return ret;
        },
        __wbindgen_generic_0000000000000005: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("GPURenderPipeline")], shim_idx: 2261, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h097b13ea2da0a79b_200);
            return ret;
        },
        __wbindgen_generic_0000000000000006: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("GPUUncapturedErrorEvent")], shim_idx: 2259, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hb1d9772773f8ef96_201);
            return ret;
        },
        __wbindgen_generic_0000000000000007: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("any")], shim_idx: 2261, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h097b13ea2da0a79b_202);
            return ret;
        },
        __wbindgen_generic_0000000000000008: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("undefined")], shim_idx: 2261, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h097b13ea2da0a79b_203);
            return ret;
        },
        __wbindgen_generic_0000000000000009: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 36, ret: Boolean, inner_ret: Some(Boolean) }, mutable: false }) -> Externref`.
            const ret = makeClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h5d564704faae10d7);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./layer_web_bg.js": import0,
    };
}

function wasm_bindgen__convert__closures_____invoke__h5d564704faae10d7(arg0, arg1) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h5d564704faae10d7(arg0, arg1);
    return ret !== 0;
}

function wasm_bindgen__convert__closures_____invoke__hb1d9772773f8ef96(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__hb1d9772773f8ef96(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__hb1d9772773f8ef96_201(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__hb1d9772773f8ef96_201(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__hb9650d4d790454a3(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__hb9650d4d790454a3(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h097b13ea2da0a79b(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h097b13ea2da0a79b(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h097b13ea2da0a79b_198(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h097b13ea2da0a79b_198(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h097b13ea2da0a79b_200(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h097b13ea2da0a79b_200(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h097b13ea2da0a79b_202(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h097b13ea2da0a79b_202(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h097b13ea2da0a79b_203(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h097b13ea2da0a79b_203(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h55ec132eb4f3ab70(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h55ec132eb4f3ab70(arg0, arg1, arg2, arg3);
}
...
const WebRecoveryCaptureFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_webrecoverycapture_free(ptr, 1));
...
const WebToneFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_webtone_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL("layer_web_bg.e90bd71dc62cbc205229.wasm", import.meta.url);
    }
    const imports = __wbg_get_imports();
