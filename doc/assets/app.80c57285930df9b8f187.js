import init, { WebApp, WebGpu, configure_raster_worker } from "./pkg/layer_web.80fb2705272771082186.js";
import { createRasterWorker } from "./raster-worker-client.1ae67106e48a3e969eac.js";
import { createDocumentStorage } from "./document-storage.0cd79375ad1454702a49.js";
import { createWorkspaceClient } from "./workspace-store.47d94f330959acc88fb7.js";
import { createWorkspaceManager } from "./workspace-manager.fb1e4efd27335879017f.js";
import { createPreferences } from "./preferences.f69b35efd6744b389c53.js";
...
import { createEditorPanels } from "./editor-panels.cb3029495b81acd8bf15.js";
import { createWorkspaceChrome } from "./workspace-chrome.d80a00db242aa9400add.js";
import { createDocuments } from "./documents.2117c818a6073348c110.js";
import { createSystemStatus } from "./system-status.0b65cd2ebafa25dc9cf0.js";
import { createHeader } from "./header.9fa2db05f9dc4f9bae8c.js";
import { createNumberField } from "./numeric.9da6fc00fab7ed615c33.js";
import { createLayerPanel } from "./layers.f4d13d8472e4dabfea32.js";
